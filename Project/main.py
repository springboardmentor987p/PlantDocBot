...
from models.model import newCNN_gray as newCNN
...
image_transform = transforms.Compose([
    ...
    transforms.Resize((224, 224)),                # <-- Must be 224x224!
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.4487], std=[0.1831])
])
...
IMAGE_LOADED = False
IMAGE_MODEL_PATH = "final_newCNN_gray_model.pth"
